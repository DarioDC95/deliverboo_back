...
<main>
    <section>
        <div class="container">
            <div class="row my-5">
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="{{ route('admin.dishes.edit', $dish->id) }}" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i> Modifica</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <img class="img-fluid w-15 mb-3" style="width: 100%; max-width: 350px;" src="{{ asset('storage/' . $dish->image_path) }}" alt="Immagine di copertina del ristorante {{ $dish->name }}">
                </div>
                <div class="col-md-6">
                    <h4>Ingredienti:</h4>
