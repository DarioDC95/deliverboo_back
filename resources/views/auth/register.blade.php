            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" class="myform" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        {{-- nome ristorante  --}}
                        <div class="mb-4 row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Nome Ristorante') }}<sup>&#8727</sup></label>
                        ...
                        {{-- email --}}
                        <div class="mb-4 row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail ') }}<sup>&#8727</sup></label>
                        ...
                        {{-- password --}}
                        <div class="mb-4 row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Password') }}<sup>&#8727</sup></label>
                        ...
                        {{-- conferma password --}}
                        <div class="mb-4 row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Conferma Password') }}<sup>&#8727</sup></label>
                        ...
                        {{-- indirizzo --}}
                        <div class="mb-4 row">
                            <label for="address" class="col-md-4 col-form-label text-md-right">{{ __('Indirizzo ') }}<sup>&#8727</sup></label>
                        ...
                        {{-- P. iva --}}
                        <div class="mb-4 row">
                            <label for="p_iva" class="col-md-4 col-form-label text-md-right">{{ __('P.IVA ') }}<sup>&#8727</sup></label>
                        ...
                        <div class="mb-4 row">
                            ...
                            <label for="types" class="col-md-4 col-form-label text-md-right">{{ __('Tipologia') }}<sup>&#8727</sup></label>
                    ...
                    <div class="mt-3">
                        <em>I campi contrassegnati da <sup>&#8727</sup> sono obbligatori</em>
                    </div>
                </div>
            </div>
        </div>
